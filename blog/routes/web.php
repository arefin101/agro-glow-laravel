...
//*********************************************** Reports **************************************************** */
    ...
    Route::get('/home/Manager_List', 'homeController@seeManagers')->name('seeManagers');
    ...
    Route::get('/home/Add_Manager', 'homeController@addManager')->name('addManager');
    Route::post('/home/Add_Manager', 'homeController@addedManager')->name('addedManager');
    ...
    Route::get('/home/Customize_Manager', 'homeController@customizeManager')->name('customizeManager');
    Route::get('/home/Edit_Manager/{id}', 'homeController@editManager')->name('editManager');
    Route::post('/home/Edit_Manager/{id}', 'homeController@editedManager')->name('editedManager');
    Route::get('/validityManager', 'homeController@validityManager');
    Route::get('/deleteManager{id}', 'homeController@deleteManager');
