...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home/manager">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/home/manager" data-target="#collapseTwo"
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/home/manager/seeSellers">See Sellers</a>
                        <a class="collapse-item" href="/home/manager/seeFarmers">See Farmers</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/home/manager/addSeller">Add Seller</a>
                        <a class="collapse-item" href="/home/manager/addFarmer">Add Farmer</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/home/manager/customizeSeller">Sellers</a>
                        <a class="collapse-item" href="/home/manager/customizeFarmer">Farmers</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link collapsed" href="/home/manager/checkNotifications" data-target="#collapseTwo"
                   aria-expanded="true" aria-controls="collapseTwo">
