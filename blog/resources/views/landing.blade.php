            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
						...
						<div class="navbar-nav mr-auto">
                            <a href="#" class="nav-item nav-link active" style="color: white;">Pial</a>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <a style="text-decoration: none; color:  #4e73df; float: left;" class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
							...
							<h1><div class="sidebar-brand-text mx-3">Computer Shop</div></h1>
						</a>
					</div>
				...
				<div class="product-item">
					...
					<div class="product-image">
						<a href="/products/<%= product[i].id %>">
							<img src="img/<%= product[i].imageURL %> " alt="Product Image">
						</a>
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="/products/<%= //product[i].id %>">
                                    {{-- <img src="/assets/img/<%=// product[i].imageURL %>" alt="Product Image"> --}}
                                </a>
                            </div>
                            <div class="product-price">
                                <h3><span>$</span><%= //product[i].price %></h3>
